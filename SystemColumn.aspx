<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SystemColumn.aspx.cs" Inherits="DDWeb.SystemColumn" %>
...
<asp:GridView ID="dvSys" runat="server" CellPadding="4" ForeColor="#333333" 
    GridLines="None" AllowPaging="True" PageSize="50">
